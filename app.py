...
">
    <p style="color: #d0d0d0; font-size: 0.9rem; line-height: 1.6; text-align: center; margin-bottom: 1.5rem;">
        Pendeteksian ini dilakukan terhadap <span style="color: #FF6B6B; font-weight: 600;">13 kategori</span> berbeda. 
        Ada kategori <span style="color: #FF6B6B; font-weight: 600;">ujaran positif</span>, 
        <span style="color: #FF6B6B; font-weight: 600;">bahasa kasar</span>, 
        dan <span style="color: #FF6B6B; font-weight: 600;">ujaran kebencian</span> dengan berbagai sub-kategori.
    </p>
    ...
    <div style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
        ...
        ">
            ...
            "></div>
            <div style="font-size: 1.2rem; font-weight: 700; color: #4A90E2; margin-bottom: 0.3rem;">Target</div>
            <div style="font-size: 0.9rem; font-weight: 600; color: #fff; margin-bottom: 0.3rem;">Sasaran Ujaran</div>
            <div style="font-size: 0.8rem; color: #d0d0d0;">Individual dan Grup</div>
        </div>
        ...
        ">
            <div style="
                ...
                background: linear-gradient(90deg, #4A90E2, #FF6B6B);
            "></div>
            <div style="font-size: 1.2rem; font-weight: 700; color: #4A90E2; margin-bottom: 0.3rem;">Kategori</div>
            <div style="font-size: 0.9rem; font-weight: 600; color: #fff; margin-bottom: 0.3rem;">Jenis Diskriminasi</div>
            <div style="font-size: 0.8rem; color: #d0d0d0;">Agama, Ras, Fisik, Gender, dan Lain-lain</div>
        </div>
        ...
        ">
            <div style="
                ...
                background: linear-gradient(90deg, #4A90E2, #FF6B6B);
            "></div>
            <div style="font-size: 1.2rem; font-weight: 700; color: #4A90E2; margin-bottom: 0.3rem;">Intensitas</div>
            <div style="font-size: 0.9rem; font-weight: 600; color: #fff; margin-bottom: 0.3rem;">Tingkat Keparahan</div>
            <div style="font-size: 0.8rem; color: #d0d0d0;">Ringan/Sedang/Berat</div>
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
